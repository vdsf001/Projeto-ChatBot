...
lista = [["olá", "ola", "oi", "tudo bem?"],
         ["oi, tudo bem?", "oi, como vai?"],
         ["qual o seu nome?", "qual o seu nome", "como você se chama", "como você se chama?", "nome" "pode me falar o seu nome?", "pode me falar o seu nome"],
         ["consulta", "consultas", "preço", "preco", "preços", "precos", "preços seguradoras", "precos seguradoras", "consulta de preços", "consulta de precos", "consulta de preços de seguradoras", "consulta de precos de seguradoras", "gostaria de consultar os preços das seguradoras", "gostaria de consultar os precos das seguradora", "quero consultar os preços das seguradoras", "quero consultar os precos das seguradoras"],
         ...
         ["prevenção", "prevencao", "prevencao covid", "prevenção covid", "prevencao coronavirus", "prevenção coronavirus", "prevencao covid19", "prevenção covid19", "como posso me prevenir?", "como posso me prevenir"],
         ["vou sair" , "sair", "quero sair", "obrigado", "obrigado pela ajuda", "obrigada pela ajuda", "agradeço pela ajuda", "estarei saindo agora"],
         ["O que você pode fazer?", "O que você pode fazer?", "opções", "o que eu posso perguntar?", "o que eu posso perguntar"]]
...
respostas = ["Olá, eu sou " +Nome+ ", como posso ajudar?", 
             ...
             ["O que gostaria de saber sobre o Covid-19","Número de casos e mortes no Brasil","Número de casos e mortes no mundo","sintomas","Prevenção"],
             "\nDados Covid Brasil",
             "\nDados Covid Mundo",
